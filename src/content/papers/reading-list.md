...
**Tracking:** ✓ in the Read column means the paper was read end-to-end.

---

## Level 1 — Core Supervised ML

| Read | Year | Authors | Title | Concept |
|------|------|---------|-------|---------|
...
| [x] | 1970 | Hoerl & Kennard | Ridge Regression | L2 regularization |
| [ ] | 1981 | Stein | Estimation of the Mean of a Multivariate Normal Distribution | Shrinkage / SURE |
| [x] | 1996 | Tibshirani | Regression Shrinkage and Selection via the Lasso | L1 regularization |
| [x] | 2004 | Efron, Hastie, Johnstone, Tibshirani | Least Angle Regression | LARS / Lasso solution path |
